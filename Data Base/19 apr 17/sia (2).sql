...
--
ALTER TABLE `akun_a`
  MODIFY `id_akun_a` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
--
...
--
ALTER TABLE `buku_besar`
  MODIFY `id_buku_besar` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
--
...
--
ALTER TABLE `periode`
  MODIFY `id_periode` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
