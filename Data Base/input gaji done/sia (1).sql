...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2017 at 06:58 AM
...
--
ALTER TABLE `isi_jurnal`
  MODIFY `id_isi_jurnal` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `isi_relasi_akun`
  MODIFY `id_relasi_akun` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
-- AUTO_INCREMENT for table `jurnal`
--
ALTER TABLE `jurnal`
  MODIFY `id_jurnal` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `relasi_akun`
  MODIFY `id_relasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
