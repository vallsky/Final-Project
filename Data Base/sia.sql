...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2017 at 10:09 AM
...
(1, 9, 'PT.Sandang Mutiara Cemerlang', 16325650),
(2, 9, ' PT.Asia Power Global', 154162814),
...
(1, ' HT logo merk', 5000000, 1, 'Complete', '2012-01-02'),
...
--
ALTER TABLE `isi_jurnal`
  MODIFY `id_isi_jurnal` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
--
...
--
ALTER TABLE `isi_relasi_akun`
  MODIFY `id_relasi_akun` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT for table `jurnal`
--
ALTER TABLE `jurnal`
  MODIFY `id_jurnal` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `relasi_akun`
  MODIFY `id_relasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
