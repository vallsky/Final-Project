...
$tahun=0;
$tes1=$akun->get_tahun();
$tes=$akun->list_order_pending();
$tes2=$akun->get_produksi();
foreach($tes1 as $m){
$tahun+=$m['tahun'];
}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
<table>
<form action="../control/produksi.php" method="post">
<tr>
<td>Tanggal</td> <td>:</td><td> <input type="date" name="tgl" value="<?php print $tahun;?>-01-01" required="required"/></td></tr>
<tr><td>Orderan</td><td> :</td><td> <select name="orderan">
<?php 
...
<tr><td></td><td></td><td><input type="Submit" value="Add Produksi" /></td></tr>
</form></table>
<Br>
  <table id="data" class="table table-striped table-bordered datatable">
       ...
       <tbody>
						...
						<?php
							...
							?>
							<Tr>
							<Td> <?php print $m['tgl_produksi']; ?> </td>
							<Td> <?php print $m['ket']; ?> </td>
							<Td> <?php print $m['status_produksi'];?> </td>
							<Td> <a href="produksi_done.php?id=<?php print $m['id_produksi'];?>">Proses</a> </td>
							<?php
							} }
							?>
                      </tbody>
