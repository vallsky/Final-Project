...
<td><?php print $m['qty_barang']; ?></td>
<td><?php print $m['tanggal_req']; ?></td>
...
<td>
<a href="../control/update_req_pembelian.php?id=<?php print $m['id_req_pembelian'];?>">Done</a>
</td>
<?php
}
}
