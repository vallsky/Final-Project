					 ...
					 if (isset($_GET['i']))
	{
		...
		elseif ($_GET['i'] == 'sukses')
		{
			print 'Succes';
                  ...
                  <div class="x_content">
                    <br />
Close Periode <?php print $tahun; ?>
<form action="../control/closing_periode.php" method="post">
Open New Periode : <select name="year">
<?php  
for($a=0; $a<10; $a++){
$tahun+=1;
?>
<option value="<?php print $tahun;?>"><?php print $tahun;?></option>
<?php
}
?>
</select><Br>
