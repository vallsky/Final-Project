...
$tahun=0;
$tes1=$akun->get_tahun();
$tes2=$akun->get_list_b_baku();
$tes3=$akun->get_isi_produksi($id);
$tes4=$akun->get_dt_produksi($id);
$status="";
$ket="";
foreach($tes4 as $m){
$status=$m['status_produksi'];
$ket=$m['ket'];
}
...
<?php
if($status=="Proses"){
print "Produk On Proses".'<Br> '.$ket;
}
else if($status=="Complete"){
print "Produksi Complete".'<Br> '.$ket;
}
else{
?>
<form action="../control/produksi_done.php" method="post">
Bahan Baku : <select name="bahanbaku">
<?php
foreach($tes2 as $m){
?>
...
?>
<Tr>
<Td> <?php print $m['nama_bahan']; ?> </td>
<Td> <?php print $m['qty']; ?> </td>
<?php
} }
?>
</table>
...
if($status=="Proses"){?>
<Br>
<form action="../control/produksi2.php" method="post">
Tanggal : <input type="date" name="tgl" value="<?php print $tahun;?>-01-01" required="required"/><br>
<input type="hidden" name="id" value="<?php print $id; ?>" required="required"/>
<input type="Submit" value="Finish Produksi" />
</form>
...
?>
<form action="../control/produksi1.php" method="post">
<input type="hidden" name="id" value="<?php print $id; ?>" required="required"/>
<input type="Submit" value="Proses Produksi" />
</form>
<a href="../control/remove_produksi.php?id=<?php print $id; ?>" onclick="return deleletconfig()">X</a>
<?php
}
?>
