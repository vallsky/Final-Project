          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   <center> <h2><B>JURNAL PENUTUP<Br>  Tanggal 31-12-<?php print $periode; ?> </h2><center>
...
?>
<tr>
<td>31 Des <?php print $periode;?> </td>
<td>Pendapatan</td>
<?php  $sa-=$saldo_awal; ?>
<?php  $sd+=$tempd;?>
<?php  $sc+=$tempc;?>
<Td><?php print "Rp. ".number_format($saldo_awal-$tempd+$tempc,2,",","."); ?></td>
<td><?php print "Rp. ".number_format(0,2,",","."); ?> </td>
</tr>
<tr>
<td></td>
...
<?php  $sd+=$tempd;?>
<?php  $sc+=$tempc;?>
<?php  $tb=0; $tb+=$saldo_awal+$tempd-$tempc; ?>
...
<?php //-iktisar laba rugi 2 ?>

<tr> </tr>
<Tr>
<td>31 Des <?php print $periode;?> </td>
<Td>Iktisar Labar/ Rugi</td>
<td> <?php print "Rp. ".number_format($tb,2,",","."); ?> </td>
<td><?php print "Rp. ".number_format(0,2,",","."); ?> </td>
</tr>
...
<?php $modal=$m['saldo']+$debet+$credit; ?>
<?php
}
}
?>
...
<td>31 Des <?php print $periode;?> </td>
<Td>Modal </td>
<td> <?php print "Rp. ".number_format($modal,2,",","."); ?> </td>
<td><?php print "Rp. ".number_format(0,2,",","."); ?> </td>
</tr>
<?php
$status1=3;
