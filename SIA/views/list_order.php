...
<Td> <?php print $m['status_pesanan']; ?> </td>
<Td>  <?php
if($m['status_pesanan']=="Pending"){
   ?>  <a href="../control/delete_order.php?id=<?php print $m['id_pesanan'];?>">Cancel Order</a>
   <?php
}else if($m['status_pesanan']=="Need Verify"){
?>
<a href="../control/verify.php?id=<?php print $m['id_pesanan'];?>">Verify</a> /
<a href="../control/delete_order.php?id=<?php print $m['id_pesanan'];?>">Cancel Order</a><?php
}
  ?> 
  </td>
</tr>
