            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
             <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/pembelian_bahanbaku1_1.php">
Tanggal Pembelian: <input type="date" name="tgl" value="<?php print $tahun;?>-01-01" required="required"/><br>
...
<input type="hidden" value="<?php print $ht;?>" name="ht"/>
