...
<td><?php print $m['status_pengiriman']; ?></td>
<td><?php if(empty($m['tgl_pengiriman'])){
print 'None';
}else{
print $m['tgl_pengiriman']; }
?></td>
<td>
<?php
if(empty($m['tgl_pengiriman'])){
?>
<a href="pengiriman.php?id=<?php print $m['id_pengiriman'];?>">Aksi</a>
<?php
}else{
print 'Done';
}
