            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="buku_besar1.php">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <select name="periode">
									...
									foreach($tes as $m){
									?>
									<option value="<?php print $m['tahun'] ?>"><?php print $m['tahun'] ?></option>
									<?php
									}?>
