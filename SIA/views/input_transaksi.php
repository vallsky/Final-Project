            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="input_transaksi1.php">
 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Transaksi:</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="id_relasi">
							<?php
							foreach($tes as $m){
							?>
							<option value=<?php print $m['id_relasi']?>><?php print $m['nama_relasi']?></option>
							<?php
							}
							?>
							</select>
