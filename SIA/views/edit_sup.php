              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/edit_supplier.php">

					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Nama Supplier:</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" name="nama" required="required" value="<?php print $nama;?>"/>
                        </div>
                      </div>
					  <input type="hidden" name="id" required="required" value="<?php print $id;?>"/>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success">Edit Nama Supplier</button>
                        </div>
                      </div>

                    </form>
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/delete_supplier.php">
						<input type="hidden" name="id" required="required" value="<?php print $id;?>"/>                     
					 <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success">Delete Supplier</button>
                        </div>
                      </div>
