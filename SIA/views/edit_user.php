            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
					  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/edit_user.php">
<?php
foreach($data as $m){
?>
<div class="form-group">
                        ...
                        <input type="text" name="user" required="required" value="<?php print $m['user'];?>"/>
                        </div>
                      </div>
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Password : </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="password" name="password" required="required" value="<?php print $m['password'];?>"/>
                        </div>
                      </div>
