            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/req_pembelian.php">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="number" name="qty" value="1" required="required"/>
                        </div>
                      </div>
					  
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Tanggal Request: </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="date" name="tgl" value="<?php print $tahun;?>-01-01" required="required"/>
                        </div>
                      </div>
