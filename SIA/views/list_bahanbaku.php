...
<td><B><a href="isi_list_bahanbaku.php?id=<?php print $m['id_bahanbaku']; ?>" "><?php print $m['nama_bahan']; ?></a><b></td>
<?php

$tes1=$akun->get_b_baku($m['id_bahanbaku']);
$qty=0;
if($tes1!=null){
foreach($tes1 as $mm){
$qty+=$mm['qty'];
