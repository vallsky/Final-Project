              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../control/input_relasi.php">
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Nama Relasi:</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                     <input type="text" name="relasi" required="required"/>
                        </div>
                      </div>
                      ...
                      <thead>
                        <tr><th>Nama Relasi</th><Th>Action</th></tr>
                      </thead>
                      ...
                      <tbody>
						...
						?>
						<tr>
						<td><?php print $m['nama_relasi'];?></td>
						<td><a href="isi_relasi.php?id=<?php print $m['id_relasi'];?>">Edit</a></td>
						</tr>
						<?php
						}
						?>
