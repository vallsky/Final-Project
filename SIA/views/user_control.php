              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					?>
					<tr>
					<td><?php print $m['user']?></td>
					<td><?php print $m['status']?></td>
					<td><a href="edit_user.php?id=<?php print $m['id_user']?>">Edit</a></td>
					<td><a href="../control/remove_user.php?id=<?php print $m['id_user']?>"  onclick="return deleletconfig()" >Remove</a></td>
					</tr>
