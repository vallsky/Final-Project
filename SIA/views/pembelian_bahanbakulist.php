...
function createSeparator(a){
  ...
  var id_tab = document.getElementById("satuan1").value;
  if(document.getElementById("satuan1").value==""){
      document.getElementById("satuan1").value = 0;
    }else{
  document.getElementById("satuan1").value=num;
  document.getElementById("satuan").value=x;
}
}
</script>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
				  <a href="add_namabahan.php">Add Item List</a>
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="pembelian_bahanbaku1.php">
					  ...
					  <div class="form-group">
                        ...
                        <select name="nama">
							...
							foreach($tes1 as $m){
							?>
							<option value="<?php print $m['id_bahanbaku'];?>"><?php print $m['nama_bahan'] ;?></option>
							<?php
							}}
							?>
							</select>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                     <input type="number" name="qty" value="1" required="required"/><br>
                        </div>
                      </div>
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
					           ...
					           <input type="text" id="satuan1" name="satuan1"  data-required="true" onKeyUp="createSeparator(this.value)" >
                  <input type="number" id="satuan" name="satuan"  data-required="true" style="visibility:hidden" >
